...
class CheckOutItem extends Component {
  ...
  //here i can put condition for vip user
  //
  //if vip user price/=2
  componentDidMount() {
  ...
  render() {
    return (
      <Item>
        <Item.Image
          size="small"
          src="http://s3.amazonaws.com/finecooking.s3.tauntonclud.com/app/uploads/2017/04/18143835/fc71iy049-02-main.jpg"
        />
        <Item.Content verticalAlign="middle">
          ...
          <Item.Extra>
            <Button
              floated="right"
              negative
              onClick={() => this.removeFromCart(this.props.orderId)}
            >
              Cancel Item button
            </Button>
          </Item.Extra>
