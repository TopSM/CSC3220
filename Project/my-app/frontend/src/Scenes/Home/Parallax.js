...
const secondPicDescriptionStyles = {
  fontSize: 70,
  color: "ivory",
  position: "absolute",
  top: "15%",
...
const image1 =
  "https://cf.ua/m/blog/43b1da4a0a2302806bcc9702d1551645/images/gallery-1447358888-clx110114clkt-59a6da0936811.jpg";
const image2 =
  "http://www.zastavki.com/pictures/originals/2015/Food___Bread_rolls_croissants_Christmas_apple_pie_105881_.jpg";
const image3 =
  "https://i0.wp.com/blog.hellofresh.com/wp-content/uploads/2017/02/veggies-winter-food-gradient-table-banner-red.jpg?ssl=1";
      ...
      <div style={styles}>
        <Parallax bgImage={image1} strength={300}>
          <div style={{ height: 1000 }}>
            <div style={insideStyles}>Meal Runner</div>
        ...
        <Parallax bgImage={image3} blur={{ min: -1, max: 3 }}>
          <div style={{ height: 1000 }}>
            ...
            <div style={secondCaptionStyles}>
              Meal Runner provide users the opportunity to showcase{"\n"} their
              culinary talent whether you are an expert chef or a{"\n"}{" "}
              stay-at-home-mom. On the flipside, as a customer you{"\n"} will
              enjoy meals made by people who know what{"\n"} authentic means.
            </div>
